...
public class MenuController : MonoBehaviour
{
    ...
    private void LoadDiplomacyTable()
    {
    ...
    private void AddMilitaryUnit2List(string request, JSONNode result)
    {
        if (result["info"] == 1)
        {
    ...
    private void AddAggrement2List(string request, JSONNode result)
    {
        if (result["info"] == 1)
        {
            JSONNode details = result["details"];
    ...
    private void AddLaw2List(string request, JSONNode result)
    {
        if (result["info"] == 1)
        {
            JSONNode details = result["details"];
    ...
    private void AddBudget2List(string request, JSONNode result)
    {
        if (result["info"] == 1)
        {
            JSONNode details = result["details"];
